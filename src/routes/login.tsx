...
import { ArrowRight, Bot, Eye, EyeOff, LoaderCircle, Lock, Mail, Sparkles } from "lucide-react";
          ...
          <section className="flex items-center justify-start h-screen">
            <div className="relative flex max-w-[520px] flex-col items-start text-left">
              ...
              <div className="relative mt-8">
                <p className="text-lg font-semibold tracking-[0.22em] text-primary uppercase">
                ...
                <p className="mt-4 max-w-[34rem] text-lg leading-6 text-muted-foreground/95">
                  Scholarii brings operations, communication, attendance, and AI assistance into one
                  workspace.
                </p>
              </div>
                ...
                <div className="flex items-center justify-center p-3 lg:p-8 bg-background">
                  <div className="w-full max-w-md">
                    <Link to="/" className="lg:hidden flex items-center gap-2 mb-8">
                      <div className="size-8 rounded-lg bg-brand-gradient grid place-items-center text-white font-bold">
                        S
                      </div>
                    ...
                    <form onSubmit={submit} className="mt-8 space-y-4">
                      ...
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <a
                          ...
                          onClick={(e) => {
                            e.preventDefault();
                            toast.info("Password reset is demo-only.");
                          }}
                      ...
                      <Button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-brand-gradient text-white border-0 hover:opacity-90 shadow-glow"
                      >
                        {loading ? (
                          "Signing in..."
                        ) : (
    ...
    <div className="space-y-2">
      ...
      <div className="group relative">
        ...
        <div className="relative">
          ...
          {trailingButton ? (
            <div className="absolute right-2 top-1/2 -translate-y-1/2">{trailingButton}</div>
          ) : null}
        </div>
      </div>
    </div>
